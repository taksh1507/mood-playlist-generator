...
import PlaylistStore from '@/app/components/PlaylistStore';
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      <header className="bg-gradient-to-r from-blue-600 via-teal-600 to-cyan-600 text-white shadow-2xl border-b border-cyan-500/20">
        <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          <p className="text-cyan-100 text-lg font-light">
            Browse and manage all your generated playlists
          </p>
        </div>
      </header>
      ...
      <nav className="bg-slate-800/50 backdrop-blur border-b border-slate-700">
        <div className="max-w-6xl mx-auto px-6 py-4 flex gap-8">
          ...
          <a href="/playlists" className="text-cyan-400 font-semibold hover:text-cyan-300 transition duration-300 border-b-2 border-cyan-400 pb-2">
            🎬 Playlists
          </a>
